...
public class MyHashMap<K, V> {
	...
	public static void main(String[] args) {
		...
		likesPerPost.put("Learning Hash Map1", 51);
		likesPerPost.put("Learning Hash Map2", 52);
		likesPerPost.put("Learning Hash Map", 53);
		likesPerPost.put("Learning Hash Map1", 54);
		likesPerPost.put("Learning Hash Map2", 55);
		likesPerPost.put("Learning Hash Map5", 56);
		likesPerPost.put("Learning Hash Map6", 57);
		likesPerPost.put("Learning Hash Map7", 58);
		
		likesPerPost.put("Learning Hash Map59", 59);
		likesPerPost.put("Learning Hash Map60", 60);
		likesPerPost.put("Learning Hash Map61", 61);
